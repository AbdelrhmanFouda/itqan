  ...
  return (
    <div dir={isAr ? "rtl" : "ltr"} className="max-w-5xl">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-8">
        ...
        <Stat label={a.finance.downtime} value={fmt(downtimeMonth)} sub={a.finance.min} />
        <Stat label={a.finance.activeJobs} value={fmt(activeJobs)} />
        <Stat label={a.finance.overdue} value={fmt(overdue)} tone={overdue > 0 ? "red" : undefined} />
      </div>
